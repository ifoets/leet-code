...
import interview.preparation.company.interviews.Utils.SListUtils;
...
public class WissenInfotechImpl implements IWissenInfotech {
	...
	public Map<String, String> getMapOrderByValuesX(Map<String, String> map) {
		...
		for (Entry<String, String> innMap : list) {
	...
	public Map<String, String> getMapOrderByValuesThenByKey(Map<String, String> map) {
		return
				map.entrySet().stream()
						.sorted(Entry.<String, String>comparingByValue()
	...
	public LNode getInterSectionNode(LNode x, LNode y) {
		int l1 = interview.preparation.company.interviews.Utils.SListUtils.length(x);
...
//0 special, 1 constlower,2 volwel lowr, 3, constupper, 4 vowel upper, 5 for numeric
    ...
    public String sortOnFrequency(String str){
        ...
        map = map
            .entrySet().stream().sorted(Entry.<Character,Integer>comparingByValue().reversed())
            .collect(Collectors.toMap(
                Entry::getKey,
                Entry::getValue,
                (e1,e2)-> e1,
    ...
    public String sortOnFrequencyThenAlpha(String str){
        ...
        Map<Character, Long> map = str.chars().mapToObj(c->(char)c)
            ...
            .stream()
            .sorted(
                Entry.<Character,Long>comparingByValue().reversed()
